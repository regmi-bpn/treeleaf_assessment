...
import com.example.treeleaf_assessment.commons.SecurityProperty;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth.requestMatchers(securityProperty.getPermitUrls().toArray(String[]::new)).permitAll()
